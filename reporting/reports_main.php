...
$reports->addReport(RC_INVENTORY, 309,_('Item &Sales Summary Report'),
	array(	_('Start Date') => 'DATEBEGINM',
			...
			_('Orientation') => 'ORIENTATION',
			_('Destination') => 'DESTINATION'));	
$reports->addReport(RC_INVENTORY, 310, _('Barcode Printing'),
	array(	_('Item') => 'ITEMS_P',     
			_('Number of Barcodes') => 'TEXT',));
if (get_company_pref('use_manufacturing'))
{
//	$reports->addReportClass(_('Manufacturing'), RC_MANUFACTURE); //FL COMMENTED
...
{
//	$reports->addReportClass(_('Fixed Assets'), RC_FIXEDASSETS);//fl comented
...
//$reports->addReportClass(_('Dimensions'), RC_DIMENSIONS); //fl comented
if ($dim > 0)
{
