...
function item_settings(&$stock_id, $new_item) 
{
	...
	if ($new_item) 
	{
		text_row(_("Item Code:"), 'NewStockID', (10000+str_pad(get_item_code_auto()['Auto_increment'],4,0,STR_PAD_LEFT)), 21, 20);
//		text_row(_("Item Code:"), 'NewStockID', null, 21, 20); FL HIDED
